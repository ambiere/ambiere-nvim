...
map("n", "<leader>cp", ":Colortils picker<c-r>", { desc = "Open color picker" })
map("n", "<leader>cpl", ":Colortils lighten<c-r>", { desc = "Open color picker lighten" })
map("n", "<leader>cpd", ":Colortils darken<c-r>", { desc = "Open color picker darken" })
map("n", "<leader>cpg", ":Colortils greyscale<c-r>", { desc = "Open color picker greyscale" })
map("n", "<leader>cpc", ":Colortils css list<c-r>", { desc = "Open color picker css list" })
